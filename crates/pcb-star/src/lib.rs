//! Diode Star – evaluate .star designs and return schematic data structures.
...
pub use pcb_star_core::bundle::{Bundle, BundleMetadata};
pub use pcb_star_core::{Diagnostic, WithDiagnostics};
