...
struct ModuleInfo {
    file_provider: Arc<dyn pcb_star_core::FileProvider>,
    load_resolver: Option<Arc<dyn pcb_star_core::LoadResolver>>,
    main_file: PathBuf,
    module_name: String,
}
...
impl Module {
    ...
    pub fn from_files(
        ...
        let module_info = ModuleInfo {
            file_provider: file_provider as Arc<dyn pcb_star_core::FileProvider>,
            load_resolver: None,
    ...
    pub fn from_bundle(bundle_bytes: &[u8], module_name: &str) -> Result<Module, JsValue> {
        ...
        let module_info = ModuleInfo {
            ...
            load_resolver: Some(bundle_resolver as Arc<dyn pcb_star_core::LoadResolver>),
            main_file,
            module_name: module_name.to_string(),
        };
    ...
    pub fn introspect(&self, partial_inputs_json: Option<String>) -> Result<String, JsValue> {
        ...
        let mut eval_ctx =
            pcb_star_core::EvalContext::with_file_provider(module_info.file_provider.clone());
